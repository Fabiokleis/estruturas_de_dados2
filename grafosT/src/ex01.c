...
//========adicionar_aresta_mat============
void adicionar_aresta_mat (int i, int j, GrafoM *G) {
   _adicionar_aresta_mat (i, j, G);
   _adicionar_aresta_mat (j, i, G);
   G->E++;
}

//=======_adicionar_aresta_adj===================
void _adicionar_aresta_adj (int i, int j, GrafoA *G) {
   NoA *aux, *ultimo = NULL;
   //acha última posição da lista e verifica se aresta ainda 
   //não está na lista
